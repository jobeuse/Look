...
<link href="{{ asset('assets/css/cs-automobile-plugin.css')}}" rel="stylesheet">
...
<body class="wp-automobile"> 
	...
	<div class="alert alert-danger alert-dismissable">
		...
		<i class="icon-error_outline"></i><span>{{ session('error') }}</span> 
	</div>
	@endif
	@if(session('success'))
	<div class="alert alert-success alert-dismissable">
		<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
		<i class="icon-error_outline"></i><span>{{ session('success') }}</span> 
	</div>
	@endif
	@yield('content')
		<!-- Footer Start -->

...
@section('content')   
  <x-nav/>
	...
	<div class="main-section">
    	<div class="page-section" style="background:url({{ asset('assets/extra-images/user-bg-img.jpg') }}) no-repeat;background-size:cover;min-height:175px;margin-top:-30px;margin-bottom:-129px;"></div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						          ...
						          <ul class="cs-featurelisted-car">
						              ...
						              <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						               <div class="cs-media">
						                 <figure><a href="#"><img src="assets/extra-images/car-shortlisted-img5.jpg" alt=""/></a></figure>
						               </div>
						               <div class="cs-text"> 

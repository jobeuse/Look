                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="image-frame defualt" style="padding-top:40px;">
                            <div class="cs-media">
                                <figure> <img src="assets/extra-images/image-frame-1.png" alt=""/> </figure>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="cs-column-text"> <span class="cs-bgcolor" style="color:#fff; padding:5px 20px; text-shadow: 3px 4px 6px rgba(0,0,0,.37); margin-bottom:20px;">{{ config('app.name') }} Services</span>
                            <h1 style="color:#fff !important; font-size:50px !important; line-height:53px !important; text-shadow: 3px 4px 6px rgba(0,0,0,.37);">AUTO ELECTRICITY,
                                VEHICLE PROGRAMMING... <a href="" class=""><span class="cs-bgcolor" style="color:#fff; padding:5px 20px; text-shadow: 3px 4px 6px rgba(0,0,0,.37); margin-bottom:20px;">{{ config('app.name') }} More</span></a>
                                </h1>
                                    ...
                                    <ul class="cs-auto-box-slider row">
                                        <li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="cs-media"> <span class="featured"></span>
                                                <figure> <a href="#"> <img src="assets/extra-images/latest-model-01.jpg" alt=""/> </a>
...
"></i></a> </div>
                                        ...
                                        <li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="cs-media">
                                                <figure> <a href="#"> <img src="assets/extra-images/latest-model-02.jpg" alt=""/> </a>
                                                    <figcaption> </figcaption>
                                                </figure>
                                                <div class="caption-text"> <a href="#">
...
"></i></a> </div>
                                        ...
                                        <li class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="cs-media">
                                                <figure> <a href="#"> <img src="assets/extra-images/latest-model-03.jpg" alt=""/> </a>
                                                    <figcaption> </figcaption>
                                                </figure>
                                                <div class="caption-text"> <a href="#">
                                                    <h2> All New 
                            ...
                            <div class="cs-blog cs-blog-grid">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="cs-blog-listing blog-grid">
                                        <div class="cs-media">
                                            <figure> <a href="#"><img src="assets/extra-images/blog-listing-1.jpg" alt="" /></a>
                                                <figcaption>
